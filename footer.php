...
<footer id="footer" role="contentinfo">
    ...
    <?php endif;?>
    <div class="my-18px">
        <?php _e('Powered by <a href="http://www.typecho.org">Typecho</a> Theme by <a href="http://www.typecho.org">18px</a> designed by <a href="http://www.typecho.org">小扬Shaun</a> with ');?>
